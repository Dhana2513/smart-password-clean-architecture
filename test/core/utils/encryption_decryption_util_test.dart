...
void main() {
  test('should return same text', () async {
    ...
    String cyperText = EncryptionDecryptionUtil.getInstance(masterKey: 'asdf').encrypt(plainText);
    String decyptedText =
        EncryptionDecryptionUtil.getInstance(masterKey: 'asdf').decrypt(cyperText);
